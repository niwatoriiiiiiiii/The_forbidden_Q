...
export class DialogBox extends Phaser.GameObjects.Container {
  ...
  constructor(public scene: Phaser.Scene, { x, y, width, height, padding=10, margin=10, textStyle={} }: DialogBoxConfig) {
    ...
    // 白枠付きの黒いRectangleを作成
    this.box = new Phaser.GameObjects.Rectangle(this.scene, x, y, width, height, 0x222222).setStrokeStyle(1, 0xffffff);
    ...
    this.actorNameBox = new Phaser.GameObjects.Rectangle(this.scene, x - width/2, y - height/2 - margin, 0, 40, 0x222222).setStrokeStyle(1, 0xffffff);
